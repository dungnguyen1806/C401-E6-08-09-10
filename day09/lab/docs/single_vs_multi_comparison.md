...
| Scenario | Day 08 | Day 09 |
|---------|--------|--------|
| Simple query (P1 SLA) | 1 LLM call | 1 LLM call (synthesis) |
| Policy query (Refund) | 1 LLM call | 1 LLM call + MCP Logic |
| Multi-hop query (P1+Access) | 1 LLM call | 2-3 Worker calls + 1 LLM call |

**Nhận xét về cost-benefit:**
Mặc dù Day 09 tốn nhiều tài nguyên tính toán hơn (latency tăng 190%), nhưng **giá trị mang lại về độ an toàn (Safety) và tính minh bạch (Traceability)** là cực kỳ xứng đáng cho môi trường doanh nghiệp. Hệ thống Day 09 có khả năng tự kiểm tra lỗi và từ chối trả lời khi không chắc chắn, điều mà Day 08 thường làm bừa.
